...
revealStyle.textContent = `
    ...
    .features-grid.revealed,
    .testimonials-grid.revealed {
        opacity: 1;
...
document.querySelectorAll('.section-header, .features-grid, .testimonials-grid').forEach(el => {
...
document.addEventListener('DOMContentLoaded', function() {
    try {
        ...
        console.log('MediPlus website initialized successfully');
    } catch (error) {
